...
export class IDXCreateComponent implements OnInit {

  title = 'Registrar IDX';
  icon = 'add';
  color = '#4caf50';
  subtitle = 'El IDX no reemplaza el diagnostico.';
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<IDXCreateComponent>,
  ...
  create() {
    ...
    const tmp = {
      idx: this.mainForm.controls.idx.value,
    };
